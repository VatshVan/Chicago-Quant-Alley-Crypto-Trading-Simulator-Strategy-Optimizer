...
def plot_evaluation(rewards, cumulative_regret, best_arm_freq, freq_over_time, true_probs):
    ...
    plt.title("Epsilon-Greedy Performance (ϵ=0.1)")
    ...
    plt.tight_layout()
    plt.savefig("plots/epsilon_greedy_evaluation.png")
    plt.close()
...
rewards, avg_reward, best_arm_freq, true_probs, cumulative_regret, freq_over_time = simulate_epsilon_greedy(epsilon=0.1)
